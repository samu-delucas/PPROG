 ...
 */
static void lab_prepare_font(sc_rectangle *sc) {
 ...
 */
void lab_move_to(sc_rectangle *sc, int r, int c) {
 ...
 */
static int lab_is_visible(sc_rectangle *sc) {
    if (!sc) return 0;
...
/*
  ...
  it.
 */
sc_rectangle *lab_win_new(int r1, int c1, int nr, int nc, int bg, int fg) {
...
/*
  ...
  Returns:
      nothing.
 */
void lab_win_cls(sc_rectangle *sc) {
    char *buf;
    int i;
...
/*
  ...
  Returns:
      nothing.
 */
void lab_win_delete(sc_rectangle *sc) {
    if (sc) free(sc);
    return;
}
 ...
 */
int lab_win_bgcol(sc_rectangle *sc, int col) {
    if (!lab_is_visible(sc)) return ERROR;
...
*/
int lab_win_fgcol(sc_rectangle *sc, int col) {
    if (!lab_is_visible(sc)) return ERROR;
 ...
 */
int lab_win_write_line_at(sc_rectangle *sc, int r, int c, char *str) {
    char *nl_p;
    char save, av_space, ret;

    if (!lab_is_visible(sc)) return 0;
...
*/
int lab_win_write_char_at(sc_rectangle *sc, int r, int c, char ch) {
